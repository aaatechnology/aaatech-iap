...
public class IAPManager {
    ...
    /**
     * Ite creates new instance of specified Appsotore({@link PlayStore}
     *
     ...
     *
     * @param showAlert <br/><code>Default: false</code>. i.e never shows alert/dialog popup
     */
     ...
     *
     * @return instance of {@link PlayStore}
     */
    ...
    public void setIAPList(IAPItem... items) {
        this.iapList = new ArrayList<IAPItem>(Arrays.asList(items));
    }
    ...
    public void getAvailableItems(ArrayList<IAPItem> iapList, String itemGroupId, ProductType productType) {
        ...
        appStore.getAvailableItems(list, productType);
    }
     ...
     * @see IAPItem
     * @see PlayStore#purchase(ProductType, String, String, boolean)
     */
    synchronized public void purchase(IAPItem item) {
        purchase(item, null, true);
    }
     ...
     * @see PlayStore#purchase(ProductType, String, String, boolean)
     */
    synchronized public void purchase(IAPItem item, String payload, boolean consumePurchase) {
        checkInitialization();
        _requestedSKU = item.getSku();

        appStore.purchase(item.getProductType(), item.getSku(), payload, consumePurchase);
    }
     ...
     * @see IAPManager#purchase(IAPItem)
     ...
     * Common to all.
     *
     * @see PlayStore#getPurchasedItems()
     */
    public void getPurchasedItems() {
        checkInitialization();

        appStore.getPurchasedItems();
    }
