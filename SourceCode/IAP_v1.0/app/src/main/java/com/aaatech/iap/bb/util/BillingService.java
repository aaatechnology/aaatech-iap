...
import com.aaatech.iap.bb.util.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        //NOTE: test code from bb community
        registerBillingReceiver();
    }

    public void registerBillingReceiver() {
        ...
        registerReceiver(billingReceiver, filter);
    }
    
    public void unRegisterBillingReceiver() {
