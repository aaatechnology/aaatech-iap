...
public abstract class BaseAppStore {
	...
	abstract public void getAvailableItems(List<String> list, String itemGroupId, ProductType productType);
	
	abstract public void purchase(ProductType productType, String sku, String payload, 
			String itemGroupId, String itemId, boolean consumePurchase);

	abstract public void getPurchasedItems(String itemGroupId);
